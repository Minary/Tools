      ...
      while (true)
      {
        ...
        try
        {
          ...
          else
          {
            ...
            Logging.Instance.LogMessage(this.requestObj.Id, Logging.Level.DEBUG, "HttpReverseProxy.ProcessClientRequest(): Headers and terminating empty line ({0}) sent", this.requestObj.ServerStatusLine.NewlineType);
