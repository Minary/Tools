namespace HttpReverseProxy.Https
{
  ...
  public class RequestHandlerHttps
  {
    ...
    public void ProcessClientRequest()
    {
      ...
      while (true)
      {
        ...
        try
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.ProcessClientRequest(): Data transmission mode C2S is: {0}", this.requestObj.ProxyDataTransmissionModeC2S.ToString());
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.ProcessClientRequest(): Data transmission mode S2C is: {0}", this.requestObj.ProxyDataTransmissionModeS2C);
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.ProcessClientRequest(): DONE! All data transferred to client");
        }
        catch (ClientNotificationException cnex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, requestObj.ProxyProtocol, Logging.Level.WARNING, "HttpsReverseProxy.ProcessClientRequest(ClientNotificationException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, cnex.Message, cnex.StackTrace);
          break;
        }
        catch (ProxyErrorException peex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, requestObj.ProxyProtocol, Logging.Level.ERROR, "HttpsReverseProxy.ProcessClientRequest(ProxyErrorException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, peex.Message, peex.StackTrace);
          break;
        }
        catch (WebException wex)
        {
          string innerException = (wex.InnerException != null) ? wex.InnerException.Message : "No inner exception found";
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.WARNING, "HttpsReverseProxy.ProcessClientRequest(WebException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, wex.Message, wex.StackTrace);
        ...
        catch (System.IO.IOException ioex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.ERROR, "HttpsReverseProxy.ProcessClientRequest(IOException): Inner exception:{0}\r\nRegular exception: {1}={2}\r\n{3}", innerException, ioex.GetType(), ioex.Message, ioex.StackTrace);
          //break;
        }
        catch (ObjectDisposedException odex)
        {
          string innerException = (odex.InnerException != null) ? odex.InnerException.Message : "No inner exception found";
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.ERROR, "HttpsReverseProxy.ProcessClientRequest(ObjectDisposedException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, odex.Message, odex.StackTrace);
          break;
        }
        catch (SocketException sex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.WARNING, "HttpsReverseProxy.ProcessClientRequest(SocketException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, sex.Message, sex.StackTrace);
          break;
        }
        catch (Exception ex)
        {
          string innerException = (ex.InnerException != null) ? ex.InnerException.Message : "No inner exception found";
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.ERROR, "HttpsReverseProxy.ProcessClientRequest(Exception): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, ex.Message, ex.StackTrace);
          break;
        }
    ...
    private bool CloseClientServerConnection(RequestObj requestObj)
    {
      ...
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.CloseClientServerConnection(): Server closed connection. Closing connection");
        return true;
      }
      else if (this.requestObj.TcpClientConnection.Connected == false)
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.CloseClientServerConnection(): Client closed connection. Closing connection");
        return true;
      }
      else if (this.requestObj.ClientRequestObj.IsClientKeepAlive == false)
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.CloseClientServerConnection(): Client HTTP connection \"close\". Closing connection");
        return true;
      }
      else if (this.requestObj.IsServerKeepAlive == false)
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.CloseClientServerConnection(): Server HTTP connection \"close\". Closing connection");
        return true;
      }
    ...
    private void ForwardClientRequestToServer()
    {
      ...
      Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.DEBUG, "HttpsReverseProxy.ForwardClientRequestToServer(): Create HTTPS socket connection to {0}", this.requestObj.ClientRequestObj.Host);
    ...
    private bool IsServerResponseDataProcessable(RequestObj requestObj)
    {
      ...
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.INFO, "HttpsReverseProxy.IsServerResponseDataProcessable():\"{0}\" is not processed", this.requestObj.ServerResponseObj.ContentTypeEncoding.ContentType);
        return false;
      }
      ...
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.INFO, "HttpsReverseProxy.IsServerResponseDataProcessable(): The content length is greater than the upper limit (contentLength:{0}, UpperLimit:{1}", this.requestObj.ServerResponseObj.ContentLength, dataDownloadUpperLimit);
        return false;
      }
    ...
    private bool IsClientRequestDataProcessable(RequestObj requestObj)
    {
      ...
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.INFO, "HttpsReverseProxy.IsClientRequestDataProcessable(): \"{ 0}\" is not processed", this.requestObj.ClientRequestObj.ContentTypeEncoding.ContentType);
        return false;
      }
      ...
      {
        Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Logging.Level.INFO, "HttpsReverseProxy.IsClientRequestDataProcessable(): The content length is greater than the upper limit (contentLength:{0}, UpperLimit:{1}", this.requestObj.ServerResponseObj.ContentLength, dataDownloadUpperLimit);
        return false;
      }
