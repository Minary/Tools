    ...
    public void ProcessClientRequest()
    {
      ...
      while (true)
      {
        ...
        catch (ClientNotificationException cnex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Loglevel.WARNING, "HttpsReverseProxy.ProcessClientRequest(ClientNotificationException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, cnex.Message, cnex.StackTrace);
          break;
        }
        ...
        catch (WebException wex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Loglevel.WARNING, "HttpsReverseProxy.ProcessClientRequest(WebException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, wex.Message, wex.StackTrace);
        ...
        catch (System.IO.IOException ioex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Loglevel.ERROR, "HttpsReverseProxy.ProcessClientRequest(IOException): Inner exception:{0}\r\nRegular exception: {1}={2}", innerException, ioex.GetType(), ioex.Message);
          break;
        }
        ...
        catch (SocketException sex)
        {
          ...
          Logging.Instance.LogMessage(this.requestObj.Id, this.requestObj.ProxyProtocol, Loglevel.WARNING, "HttpsReverseProxy.ProcessClientRequest(SocketException): Inner exception:{0}\r\nRegular exception: {1}\r\n{2}", innerException, sex.Message, sex.StackTrace);
          break;
        }
        catch (Exception ex)
        {
